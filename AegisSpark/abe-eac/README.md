...
| `[curve]` `[abe]` `[aead]` `[signature]` `[tee]` | crypto: curve, CP-ABE, AES-GCM, Ed25519, WV keys |
...
|-----------|--------|------|
| `CryptoProvider` | `crypto_iface.hpp` | CP-ABE / AES-GCM / Ed25519 factory |
