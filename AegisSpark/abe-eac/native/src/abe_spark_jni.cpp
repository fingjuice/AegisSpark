...
JNIEXPORT jboolean JNICALL Java_org_apache_spark_abe_AbeNativeBridge_verifyEcdsa(
	JNIEnv* env, jclass,
	jbyteArray message,
...
JNIEXPORT jstring JNICALL Java_org_apache_spark_abe_AbeNativeBridge_signEcdsa(
	JNIEnv* env, jclass,
	jbyteArray message,
